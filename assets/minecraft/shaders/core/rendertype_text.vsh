...
void main() {
    ...
    MinimapSize = vec2(MINIMAP_SIZE, MINIMAP_SIZE) * guiScale;
    isMap = 0.0;
    isShadow = 0.0;
    ...
    if(isMap == 1.0 && Position.z == 0.03/* 0.035 */){
        ...
        // vec3 floatColor = Color.rgb;
        // ivec3 color = ivec3(floatColor.r * 255, floatColor.g * 255, floatColor.b * 255);
